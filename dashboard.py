...
class IMS:
    def __init__(self,root):
        ...
        #===clock===
        self.lbl_clock=Label(self.root,text="Welcome to Inventory Management System\t\t Sate: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15),bg="#4d636d",fg="white")
        ...
        #===footer===
        lbl_footer=Label(self.root,text="IMS- Inventory Management System | Developed by Layana Lajudheen",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
#===================================================================================
    def employee(self):
